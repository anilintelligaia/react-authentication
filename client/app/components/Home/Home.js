      ...
      return (
        <div className="outer-container">
          <div className="signinBox">
            {signInError ? <p class="error-msg">{signInError}</p> : null}
            <p className="signinBox--heading">Sign In</p>
            <input
              type="email"
              placeholder="Email"
              value={signInEmail}
          ...
          <div className="signupBox">
            ...
            <p className="signupBox--heading">Sign Up</p>
